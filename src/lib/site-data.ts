...
export const camps: CampItem[] = [
  {
    ...
    period: '2026.07.23 - 07.25',
    location: '제주청소년수련원',
    participants: '자립 및 미자립 교회 청소년',
    price: '자립 80,000원 / 미자립 40,000원 / 사전등록 자립 75,000원 (7월 6일까지)',
    status: '준비중',
    slug: 'hanada',
    description: '파스텔 무드와 세대적 감각 위에, 하나님 나라의 시선으로 트렌드를 다시 입혀보는 새로운 하나다캠프.',
    features: ['트렌드 세션', '비주얼 워십', '크리에이티브 미션', '공동체 경험'],
    image: getAssetPath('/images/hanada-camp-poster.jpg'),
  },
  {
    id: 2,
  ...
  },
  {
    ...
    image: getAssetPath('/images/andcampposter.jpg'),
  },
]
